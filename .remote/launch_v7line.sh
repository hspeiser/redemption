...
nohup .venv/bin/python scripts/fastsim_train_ppo.py \
  ...
  --demo-corridor 0.8 --speed-cap 8 \
  > data/fastsim_runs/ppo_v7line/stdout.log 2>&1 &
echo "launched v6obs pid $!"
sleep 75
tail -2 data/fastsim_runs/ppo_v7line/stdout.log
