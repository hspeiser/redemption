...
nohup .venv/bin/python scripts/fastsim_train_ppo.py \
  ...
  > data/fastsim_runs/ppo_v4rel/stdout.log 2>&1 &
echo "launched v4rel pid $!"
sleep 75
tail -2 data/fastsim_runs/ppo_v4rel/stdout.log
