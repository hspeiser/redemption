...
nohup .venv/bin/python scripts/fastsim_train_ppo.py \
  ...
  > data/fastsim_runs/ppo_truth/stdout.log 2>&1 &
echo "launched round3 pid $!"
sleep 60
tail -3 data/fastsim_runs/ppo_truth/stdout.log
