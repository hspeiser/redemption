...
$outputRoot = 'D:\ai-gp\training\vq2_all17_ppo_v3_late_safe_live_ab'
$checkpoint = 'D:\ai-gp\worldmodel\ppo_all17_multimodel_v3_late_safe\best_iter220.pt'
...
Start-Process -FilePath $python -ArgumentList $arguments `
    ...
    -RedirectStandardOutput (Join-Path $logRoot 'vq2_all17_ppo_v3_late_safe_ab.stdout.log') `
    -RedirectStandardError (Join-Path $logRoot 'vq2_all17_ppo_v3_late_safe_ab.stderr.log') | Select-Object -ExpandProperty Id
