...
nohup .venv/bin/python scripts/fastsim_train_ppo.py \
  ...
  --demo-corridor 1.5 --speed-cap 8 --spawn-at-rest \
  > data/fastsim_runs/ppo_v9rest/stdout.log 2>&1 &
echo "launched v6obs pid $!"
sleep 75
tail -2 data/fastsim_runs/ppo_v9rest/stdout.log
