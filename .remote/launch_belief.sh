...
nohup .venv/bin/python scripts/fastsim_train_ppo.py \
  ...
  > data/fastsim_runs/ppo_belief/stdout.log 2>&1 &
echo "launched belief-frame run pid $!"
sleep 60
tail -3 data/fastsim_runs/ppo_belief/stdout.log
