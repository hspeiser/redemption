...
& $python -u scripts\optimize_vq2_g0g4_worldmodel.py `
    --dataset worldmodel\g0g4_current_aug_20_live_abba_v7 `
    --ensemble worldmodel\v25_live_abba_v7\residual_ensemble_v24.pt `
    ...
    --initial worldmodel\g0g4_v22only_tier87_cem_v1.json `
    ...
    --seed 20260894 `
    --device cuda `
    --out worldmodel\g0g4_dyna_r1_v24v25_cem_v1.json
exit $LASTEXITCODE
