...
set OUT=worldmodel\repairs\g2_ep2_distilled_regression_v3
set LOG=worldmodel\repairs\g2_ep2_distilled_regression_v3.log
if exist "%OUT%" (
...
for %%M in (v23 v24 v25) do (
  ...
  call :audit candidate %%M worldmodel\repairs\g2_ep2_distill_inputs\candidate_config_phase075.json
  if errorlevel 1 exit /b !errorlevel!
  call :audit geometry_only %%M worldmodel\repairs\g2_ep2_distill_inputs\candidate_config_phase075.json --protected-base
  if errorlevel 1 exit /b !errorlevel!
