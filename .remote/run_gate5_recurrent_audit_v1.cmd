...
.venv-train\Scripts\python.exe -u scripts\audit_vq2_recurrent_gate_actor.py ^
  --candidate worldmodel\flywheel_gate5_v1\candidate.pt ^
  ...
  --out worldmodel\flywheel_gate5_v1\fresh_audit.json ^
  --focus-gate 5 ^
  --worlds 2048 ^
  --seed 2026080251 ^
  --max-episode-s 18 ^
  ...
  --multigate-estimator ^
  --device cuda ^
  > worldmodel\flywheel_gate5_v1\audit.stdout.log ^
  2> worldmodel\flywheel_gate5_v1\audit.stderr.log

echo %ERRORLEVEL% > worldmodel\flywheel_gate5_v1\audit.exit_code.txt
