...
.venv-train\Scripts\python.exe -u scripts\search_vq2_counterfactual_repair.py ^
  ...
  --initial-report worldmodel\repairs\flywheel_g6_action_repair_v1\repair_search_report.json ^
  --population 64 ^
  --elite 8 ^
  --iterations 12 ^
  --worlds 32 ^
  ...
  --authority 0.12 ^
  --geometry-search ^
  --max-lateral-offset 0.25 ^
  --max-vertical-offset 0.20 ^
  --max-speed-scale-delta 0.08 ^
  --post-steps 30 ^
  --aleatoric-scale 1.5 ^
  --max-support-p90 3.0 ^
