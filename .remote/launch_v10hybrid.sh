...
nohup .venv/bin/python scripts/fastsim_train_ppo.py \
  ...
  --action-smoothness 0.06 --act-delay-min 1 --spawn-at-rest \
  --residual --residual-scale 0.3 \
  --obstacles data/vq2_obstacles_inflated.json \
  --demo-corridor 2.0 --speed-cap 8 \
  > data/fastsim_runs/ppo_v10hybrid/stdout.log 2>&1 &
echo "launched v10hybrid pid $!"
sleep 75
tail -2 data/fastsim_runs/ppo_v10hybrid/stdout.log
