...
nohup .venv/bin/python scripts/fastsim_train_ppo.py \
  ...
  > data/fastsim_runs/ppo_v6obs/stdout.log 2>&1 &
echo "launched v6obs pid $!"
sleep 75
tail -2 data/fastsim_runs/ppo_v6obs/stdout.log
