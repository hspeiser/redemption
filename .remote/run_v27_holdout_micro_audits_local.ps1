...
$outDir = 'D:\ai-gp\worldmodel\v27_holdout_micro_audits'
$ensemble = 'D:\ai-gp\worldmodel\v27_recent_abba_holdout\residual_ensemble_v27_holdout.pt'
$dataset = 'D:\ai-gp\worldmodel\g0g4_current_aug_22_recent_abba_holdout'
$candidates = @(
    'baseline',
    'g3t103',
    'g3t106',
...
foreach ($name in $candidates) {
    ...
    & $python -u scripts\audit_vq2_g0g4_candidate.py `
        ...
        --worlds 4096 --seed 20261010 --device cuda `
