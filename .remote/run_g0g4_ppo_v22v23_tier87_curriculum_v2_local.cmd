...
.venv-train\Scripts\python.exe -u scripts\fastsim_train_ppo.py ^
  ...
  --entropy 1e-4 ^
  --device cuda ^
  --run-dir D:\ai-gp\worldmodel\ppo_g0g4_v22v23_tier87_curriculum_v2 ^
  --rate-sign 1 ^
  ...
  --resume D:\ai-gp\worldmodel\ppo_g0g4_v22v23_tier87_v1\best.pt ^
  ...
  --race-gates 5 ^
  --max-episode-s 12 ^
  --random-start-frac 0.65 ^
  --start-gate-weights 1 1 6 6 2 ^
  --world-model ^
  ...
  1>D:\ai-gp\worldmodel\ppo_g0g4_v22v23_tier87_curriculum_v2.stdout.log ^
  2>D:\ai-gp\worldmodel\ppo_g0g4_v22v23_tier87_curriculum_v2.stderr.log
exit /b %ERRORLEVEL%
