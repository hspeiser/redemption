...
$outputRoot = 'D:\ai-gp\training\vq2_all17_ppo_v2_lategates_live_ab'
$checkpoint = 'D:\ai-gp\worldmodel\ppo_all17_multimodel_v1\best_v2_iter160.pt'
...
Start-Process -FilePath $python -ArgumentList $arguments `
    ...
    -RedirectStandardOutput (Join-Path $logRoot 'vq2_all17_ppo_v2_late_ab.stdout.log') `
    -RedirectStandardError (Join-Path $logRoot 'vq2_all17_ppo_v2_late_ab.stderr.log') | Select-Object -ExpandProperty Id
