...
if not exist worldmodel\ppo_all17_multimodel_v2 mkdir worldmodel\ppo_all17_multimodel_v2
.venv-train\Scripts\python.exe -u scripts\fastsim_train_ppo.py ^
  ...
  --entropy 1e-4 ^
  --device cuda ^
  --run-dir worldmodel\ppo_all17_multimodel_v2 ^
  --rate-sign 1 ^
  ...
  --resume worldmodel\ppo_all17_multimodel_v1\best.pt ^
  ...
  --start-gate-weights 2 2 2 2 2 2 5 5 5 5 3 5 3 4 3 3 4 ^
  --world-model ^
  ...
  --eval-envs 1024 ^
  --eval-seed 20260805 ^
  1>worldmodel\ppo_all17_multimodel_v2\stdout.log ^
  2>worldmodel\ppo_all17_multimodel_v2\stderr.log
