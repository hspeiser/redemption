...
.venv-train\Scripts\python.exe -u scripts\compare_vq2_worldmodels.py ^
  ...
  --out worldmodel\v29_allgate_registry_flywheel\fresh_registry_audit_h32.json ^
  --horizon 32 ^
  --device cuda ^
  1>worldmodel\v29_allgate_registry_flywheel\audit.stdout.log ^
  2>worldmodel\v29_allgate_registry_flywheel\audit.stderr.log
echo %ERRORLEVEL%>worldmodel\v29_allgate_registry_flywheel\audit_exit_code.txt
