...
set OUT=worldmodel\repairs\g2_ep2_distilled_regression_v5
set LOG=worldmodel\repairs\g2_ep2_distilled_regression_v5.log
if exist "%OUT%" (
...
for %%M in (v23 v24 v25) do (
  ...
  .venv-train\Scripts\python.exe scripts\audit_vq2_residual_candidate.py ^
    --actor worldmodel\repairs\g2_ep2_distilled_actor_v3.pt ^
    --ensemble !ENS! ^
