...
$outputRoot = 'D:\ai-gp\training\vq2_all17_ppo_v2_live_ab'
...
Start-Process -FilePath $python -ArgumentList $arguments `
    ...
    -RedirectStandardOutput (Join-Path $logRoot 'vq2_all17_ppo_v2_live_ab.stdout.log') `
    -RedirectStandardError (Join-Path $logRoot 'vq2_all17_ppo_v2_live_ab.stderr.log') | Select-Object -ExpandProperty Id
